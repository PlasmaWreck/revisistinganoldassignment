...
import CodeLogo from '../components/codelogo/codelogo';
            ...
            return (
                ...
                <Container>
                    <Row className='mx-5'>
                        ...
                        <CodeLogo lang={this.state.deckLang}/>
                        <FlashCard onClick={this.ChangeDef} isDef={this.state.isDef} textStyle={this.state.isDef ? "flashCardDef":"flashCardVocab"} text={this.state.isDef ? this.state.flashCardDecks[this.state.deckLang].cardDescription[this.state.counter] : this.state.flashCardDecks[this.state.deckLang].cardVocab[this.state.counter]} />
